...
class ModuleFinderSitePackagesSuite(Suite):
    def setUp(self) -> None:
        ...
        package_paths = (
            ...
            os.path.join(self.package_dir, "..", "modulefinder-src_"),
            self.package_dir,
        )
    ...
    def test__packages_with_ns(self) -> None:
        cases = [
            ...
            ("neighbor_pkg", self.path("..", "modulefinder-src_", "neighbor_pkg", "__init__.py")),
            ("ns_neighbor_pkg.a", self.path("..", "modulefinder-src_", "ns_neighbor_pkg", "a.py")),
